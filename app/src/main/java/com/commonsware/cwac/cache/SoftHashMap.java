 ...
 */
	...
	private static final int MAX_SIZE_FOR_SMALL_PHOTO = 30;
	...
	public void recycleOneBitmap(Object bitmap) {
		...
		try {
			...
			if (null != bm && !bm.getBitmap().isRecycled()) {
				...
				VTLog.e("BigPhotoCache", "bitmap is already recycled"
						+ hash.size());
			} else {
				VTLog.e("BigPhotoCache", "bitmap is not already recycled");
			}
			bm = null;
		} catch (Exception e) {
			VTLog.e("BigPhotoCache", "bm null " + e);
		}
	}
	...
	public void recycleAllBitmap() {
		...
		try {
			...
			VTLog.e("BigPhotoCache", "exception " + e.toString());
		}
	}
