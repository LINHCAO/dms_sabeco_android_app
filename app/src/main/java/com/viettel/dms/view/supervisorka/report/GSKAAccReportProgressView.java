 ...
 * Report accumulate
 */
public class GSKAAccReportProgressView extends BaseFragment implements
	...
	// main activity
	public static final String TAG = GSKAAccReportProgressView.class.getName();
	private SupervisorActivity parent;
	private VinamilkTableView tbReport;
	// private TextView tvMessage;
	private ProgressDateReportDTO dto;
	private boolean isFirst = true;

	public static GSKAAccReportProgressView getInstance(Bundle b) {
		GSKAAccReportProgressView instance = new GSKAAccReportProgressView();
	...
	private void initView(View v){
		...
		setMenuItemFocus(5);
		tbReport = (VinamilkTableView)v.findViewById(R.id.tbCusList);
