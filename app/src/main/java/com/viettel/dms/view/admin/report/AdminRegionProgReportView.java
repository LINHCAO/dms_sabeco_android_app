 ...
 * @author : tuanlt1989
 */
public class AdminRegionProgReportView extends BaseFragment implements VinamilkTableListener {

	public static final String TAG = AdminRegionProgReportView.class.getName();
	private GlobalBaseActivity parent;

	private DMSTableView tbReport;// tbCusList

	public static AdminRegionProgReportView getInstance() {
		AdminRegionProgReportView f = new AdminRegionProgReportView();
