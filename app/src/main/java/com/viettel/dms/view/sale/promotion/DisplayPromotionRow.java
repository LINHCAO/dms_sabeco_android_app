...
/**
 * Display Promotion Row
 * DisplayPromotionRow.java
 * @author: duongdt3
 * @version: 1.0 
 * @since:  11:18:46 14 Jan 2014
 */
public class DisplayPromotionRow extends TableRow implements OnClickListener {
	 ...
	 * @param aRow
	 */
	public DisplayPromotionRow(Context context, View aRow) {
		super(context);
		_context = context;
		LayoutInflater vi = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		view = vi.inflate(R.layout.layout_display_promotion_row, this);
