...
public class SupervisorPhotoThumbnailListProgrameView extends BaseFragment implements OnItemClickListener, OnClickListener {
	...
	public static final String TAG = SupervisorPhotoThumbnailListProgrameView.class.getName();
	...
	//thanhnn add du lieu de request
	String fromDate="";
	String toDate="";
	...
	public static SupervisorPhotoThumbnailListProgrameView getInstance(Bundle data) {
		SupervisorPhotoThumbnailListProgrameView instance = new SupervisorPhotoThumbnailListProgrameView();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		ViewGroup view = (ViewGroup) inflater.inflate(R.layout.layout_supervisor_album_detail_programe_view, container, false);
		...
		String staffName = data.getString(IntentConstants.INTENT_STAFF_NAME, "");
		...
		tvNVBHName = (TextView) view.findViewById(R.id.tvNVBHName);
		if (!StringUtil.isNullOrEmpty(staffCode)) {
			tvNVBHName.setText(staffCode + " - " + staffName);
		} else {
			tvNVBHName.setText(getString(R.string.ALL));
		}
		...
		updateTitle(customerCode, customerName);
	 ...
	 * @throws:
	 */
	private void updateTitle(String customerCode, String customerName) {
		SpannableObject spanObject = new SpannableObject();
		spanObject.addSpan(getString(R.string.TITLE_VIEW_ALBUM_DETAIL_PROGRAME_FROM_GSNPP));
		spanObject.addSpan(" ");
