 ...
 */
public class TrainingListRowSup extends DMSTableRow implements View.OnClickListener {
    ...
    public TrainingListRowSup(Context context, VinamilkTableListener lis) {
        super(context, R.layout.layout_sup_training_list_row);
        setListener(lis);
