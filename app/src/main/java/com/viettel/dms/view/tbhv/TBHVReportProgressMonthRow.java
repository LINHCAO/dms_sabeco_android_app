 ...
 * @since: 1.0
 */
public class TBHVReportProgressMonthRow extends TableRow implements OnClickListener {
	// table parent
	...
	public TBHVReportProgressMonthRow(Context context, View aRow, boolean isDetailScreen) {
		super(context);
		tableParent = aRow;
		_context = context;
		this.isDetailScreen = isDetailScreen;
		LayoutInflater vi = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		view = vi.inflate(R.layout.layout_tbhv_report_progress_month_row, this);
