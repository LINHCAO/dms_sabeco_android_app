...
/**
 * Report progress sale date for admin
 * 
 * @author : tuanlt1989
 */
public class AdminDateSaleProReportView extends BaseFragment implements
		OnEventControlListener, VinamilkTableListener {

	public static final String TAG = AdminDateSaleProReportView.class.getName();
	...
	public static AdminDateSaleProReportView getInstance() {
		AdminDateSaleProReportView f = new AdminDateSaleProReportView();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup view = (ViewGroup) inflater.inflate(
				R.layout.layout_admin_date_sale_pro_report_view, container, false);
		View v = super.onCreateView(inflater, view, savedInstanceState);
		setTitleHeaderView(StringUtil
				.getString(R.string.TITLE_ADMIN_DATE_SALE_PRO_REPORT));
		// enable menu bar
		initMenuHeader();
