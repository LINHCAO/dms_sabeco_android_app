 ...
 * @author : tuanlt1989
 */
public class AdminAccSaleProReportView extends BaseFragment implements
		OnEventControlListener, VinamilkTableListener {

	public static final String TAG = AdminAccSaleProReportView.class.getName();
	...
	public static AdminAccSaleProReportView getInstance() {
		AdminAccSaleProReportView f = new AdminAccSaleProReportView();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup view = (ViewGroup) inflater.inflate(
				R.layout.layout_admin_acc_pro_sale_report_view, container, false);
