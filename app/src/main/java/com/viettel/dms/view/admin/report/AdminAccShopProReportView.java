 ...
 * @author : tuanlt1989
 */
public class AdminAccShopProReportView extends BaseFragment implements
		OnEventControlListener, VinamilkTableListener {

	public static final String TAG = AdminAccShopProReportView.class.getName();
	...
	public static AdminAccShopProReportView getInstance() {
		AdminAccShopProReportView f = new AdminAccShopProReportView();
