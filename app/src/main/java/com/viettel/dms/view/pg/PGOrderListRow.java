 ...
 */
public class PGOrderListRow extends TableRow implements
    ...
    public PGOrderListRow(Context con){
        super(con);
        _context = con;
     ...
     * @param context
     */
    public PGOrderListRow(Context context, VinamilkTableListener listen) {
        this(context);
        listener=listen;
