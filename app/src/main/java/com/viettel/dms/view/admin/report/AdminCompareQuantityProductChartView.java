...
/**
 * Compare quantity product chart
 * 
 * @author : tuanlt1989
 */
public class AdminCompareQuantityProductChartView extends BaseFragment implements
		OnEventControlListener, VinamilkTableListener {

	public static final String TAG = AdminCompareQuantityProductChartView.class.getName();
	...
	public static AdminCompareQuantityProductChartView getInstance() {
		AdminCompareQuantityProductChartView f = new AdminCompareQuantityProductChartView();
