 ...
 */
public class CompetitorSaleRowPG extends TableRow implements TextWatcher,
		OnClickListener {
	...
	private CompetitorSaleRowPG(Context context) {
		super(context);
		con = context;
	...
	public CompetitorSaleRowPG(Context context, int type) {
		this(context);
		this.type = type;
		initView(v);
	}
