 ...
 * @author : tuanlt1989
 */
public class AdminDateShopProReportView extends BaseFragment implements
		OnEventControlListener, VinamilkTableListener {

	public static final String TAG = AdminDateShopProReportView.class.getName();
	...
	public static AdminDateShopProReportView getInstance() {
		AdminDateShopProReportView f = new AdminDateShopProReportView();
